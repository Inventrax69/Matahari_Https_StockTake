...
public class SKUListDTO
{
    ...
    @SerializedName("MCodeAlternative1")
    private String MCodeAlternative1;
            ...
            for (Map.Entry<?, ?> entry : entries) {
                ...
                switch (entry.getKey().toString()) {
                   ...
                   case  "CustomerName" :
                    ...
                    case  "MCodeAlternative1" :
                        if(entry.getValue()!=null) {
                            this.setMCodeAlternative1(entry.getValue().toString());
                        }
                        break;
                }
            }
    ...
    public String getMCodeAlternative1() {
        return MCodeAlternative1;
    }

    public void setMCodeAlternative1(String MCodeAlternative1) {
        this.MCodeAlternative1 = MCodeAlternative1;
    }
}
