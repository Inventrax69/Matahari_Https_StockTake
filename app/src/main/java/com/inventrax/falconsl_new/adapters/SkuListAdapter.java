...
public class SkuListAdapter extends  RecyclerView.Adapter{
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ((MyViewHolder) holder).maltsku.setText("[ " + skuListDTO.getMCodeAlternative1() + " ]");
...
/*
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView txtQty,txtMCode,maltsku;// init the item view's
        View view;
        ...
        public MyViewHolder(View itemView) {
            ...
            maltsku = (TextView) itemView.findViewById(R.id.maltsku);
            view=itemView;
